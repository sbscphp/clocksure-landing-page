...
const testimonials = [
  {
    ...
    content:
      "Clocksure has transformed how we manage attendance across our 500+ employees. The real-time analytics have been invaluable for workforce planning.",
    rating: 5,
    avatar: "SJ",
  },
  {
    ...
    content:
      "The biometric QR scanning feature eliminated time theft completely. We've saved thousands of dollars in payroll accuracy alone.",
    rating: 5,
    avatar: "MC",
  },
  {
    ...
    company: "StartUp Hub",
    content:
      "Simple to set up, easy to use, and incredible support. Clocksure scaled with us from 10 to 200 employees without missing a beat.",
    rating: 5,
    avatar: "ER",
  },
  {
    ...
    company: "RetailMax",
    content:
      "The reporting features are exceptional. We generate compliance reports in minutes that used to take hours to compile manually.",
    rating: 5,
    avatar: "DK",
  },
];
